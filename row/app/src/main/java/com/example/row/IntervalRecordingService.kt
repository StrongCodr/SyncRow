...
import com.example.row.model.SeatSummary
...
import com.example.row.network.ApiClient
...
class IntervalRecordingService : Service() {
    ...
    companion object {
        const val ACTION_START = "com.example.row.action.START_INTERVAL"
        const val ACTION_STOP = "com.example.row.action.STOP_INTERVAL"
        const val ACTION_CONNECT_ONLY = "com.example.row.action.CONNECT_ONLY"
        private const val ACTION_RECONNECT_ALL = "com.example.row.action.RECONNECT_ALL"
        private const val ACTION_SYNC_PENDING = "com.example.row.action.SYNC_PENDING"
        private const val ACTION_APP_FOREGROUND = "com.example.row.action.APP_FOREGROUND"
        private const val ACTION_APP_BACKGROUND = "com.example.row.action.APP_BACKGROUND"
